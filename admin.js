...
// ============================================================
const EMOJI_ADMIN_TITLE_ID = "6008060777771045457";  // 🛠 заголовок панели
const ICON_ADMIN_BLOCK = "6008060777771045457";      // на кнопке "Заблокировать пользователя"
const ICON_ADMIN_UNBLOCK = "6008060777771045457";    // на кнопке "Разблокировать пользователя"
const ICON_ADMIN_DESIGN = "6008060777771045457";     // на кнопке "Дизайн"
const ICON_ADMIN_LIST = "6008060777771045457";       // на кнопке "Список заблокированных"
const ICON_ADMIN_PREMIUM = "6008060777771045457";    // на кнопке "Выдать Premium"
